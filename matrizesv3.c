    	...
    	for (i = 0; i < TAM; i++){
            for (j = 0; j < TAM; j++){
                switch (somarVizinhos (matriz, i, j)){ 
                    case 0: //Qualquer célula viva com menos de dois vizinhos vivos morre de solidão.
                    case 1:
                    	novaMatriz[i][j] = 0; 
                    break;
                    case 2:
                    ...
                    case 3: //Qualquer célula com exatamente três vizinhos vivos se torna uma célula viva.
                    	novaMatriz[i][j] = 1;  
                    break;
                    case 4: //Qualquer célula viva com mais de três vizinhos vivos morre de superpopulação
                    case 5:
                	case 6:
                	case 7:
                	case 8:
